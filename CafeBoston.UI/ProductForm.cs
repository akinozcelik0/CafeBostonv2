...
namespace CafeBoston.UI
{
    public partial class ProductForm : Form
    {
        ...
        {
            var dr = MessageBox.Show("You are deleting a product, are you sure ?", "Confirmation", MessageBoxButtons.YesNo,MessageBoxIcon.Warning, MessageBoxDefaultButton.Button2);
